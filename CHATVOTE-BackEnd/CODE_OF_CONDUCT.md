...
> If you have a separate Collaboration, Non-Disclosure and Ethical Use Agreement with the chatvote organisation, that agreement prevails where there is any conflict.

---

## 1) Purpose & Scope
This Code applies to all project spaces (GitHub issues/PRs, discussions, docs, deployments, events) and to any use of the chatvote technology derived from this repo.
...
## 6) Use of the chatvote Technology
If you deploy or adapt the technology from this repo:
- **Non-commercial only.** No profit-generating use.
- **Attribution.** Display prominently: **“Powered by chatvote (France)”** with a link to <https://chatvote.fr>.
- **Improvements.** Make improvements available to chatvote and retain all attribution/proprietary notices.
...
Please report conduct concerns, violations or security vulnerabilities privately to the maintainers (contact@chatvote.fr).
