...
export const setUserDemographic: ChatStoreActionHandlerFor<"setUserDemographic"> =
  (get, set) => (field, value) => {
...
export const loadUserDemographics: ChatStoreActionHandlerFor<"loadUserDemographics"> =
